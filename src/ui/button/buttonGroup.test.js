...
describe("button-group-component-tests", () => {
    const group = new buttonGroup_1.ButtonGroup(document.body);
    const groupStyled = new buttonGroup_1.ButtonGroup(document.body, { variant: "primary" });
    const groupDisabled = new buttonGroup_1.ButtonGroup(document.body, { disabled: true });
    it("group-add-button", () => {
