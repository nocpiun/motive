...
describe("input-component-tests", () => {
    const input = new input_1.Input(document.body, { placeholder: "Test1", maxLength: 20 });
    const disabledInput = new input_1.Input(document.body, { disabled: true });
    const numberInput = new input_1.Input(document.body, { type: "number", maxValue: 100 });
    const inputWithDefaultValue = new input_1.Input(document.body, { defaultValue: "Test2" });
    it("input-properties", () => {
